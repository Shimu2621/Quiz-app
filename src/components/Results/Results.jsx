  ...
  return (
    <div className="results">
      ...
      <div className="certificate mt-4 mb-5">
        ...
        <div>
          <h3>
            <span className="congrats">Cogratulations! </span>
            {user_name}
          </h3>
        </div>
        <div className="container row">
          <div className="col-lg-6 col-md-6 mt-5 text-center successfull">
            <h4 className="mt-5 offset-lg-4 offset-sm-0">
              You've successfully completed your quiz <br /> in Quiz Time.
            </h4>
            <h5 className="offset-lg-4 mt-3" style={{ color: "green" }}>
              Your score is {total_score} / {question_amount}
            </h5>
          </div>
